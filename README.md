...
To list a specific event type, call the `ReadEventType` function with the event type as an argument. The function returns an the detailed event type, which includes the schema:
